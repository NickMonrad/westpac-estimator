...
vi.mock('../lib/prisma.js', () => ({
  prisma: {
    ...
    $transaction: vi.fn((fn: unknown) => typeof fn === 'function' ? (fn as (tx: unknown) => unknown)({
      ...
      resourceType: { findUnique: vi.fn().mockResolvedValue(null), update: vi.fn(), create: vi.fn() },
      namedResource: { findUnique: vi.fn().mockResolvedValue(null), update: vi.fn(), create: vi.fn() },
